            ...
            <div className="blog-sidebar">
                ...
                <div className="widget tag-widget">
                    ...
                    <ul>
                        ...
                        <li><Link onClick={ClickHandler} to="/blog-single/1">Gas Line</Link></li>
                        <li><Link onClick={ClickHandler} to="/blog-single/1">Window</Link></li>
                        <li><Link onClick={ClickHandler} to="/blog-single/1">Water Line</Link></li>
                        <li><Link onClick={ClickHandler} to="/blog-single/1">Plumbing</Link></li>
                        <li><Link onClick={ClickHandler} to="/blog-single/1">Bathroom</Link></li>
                        <li><Link onClick={ClickHandler} to="/blog-single/1">Basement</Link></li>
                        <li><Link onClick={ClickHandler} to="/blog-single/1">Remodeling</Link></li>
                    </ul>
                </div>
